        ...
        <Grid container spacing={2}>
                ...
                >
                    <CardContent sx={{ flexGrow: 1 }}>
                        <Typography variant="h6" sx={{ fontWeight: 'bold', marginBottom: '16px', textAlign: 'center' }}>
                            Comentario con valoración más alta
                        </Typography>
                        <Typography variant="body1"><strong>Materia:</strong> {data.mejor.materia.nombre} - {data.mejor.materia.codigo}</Typography>
                        ...
                        <Typography variant="body1"><strong>Comentario:</strong></Typography>
            ...
            <Grid item xs={12} md={6}>
                ...
                >
                    <CardContent sx={{ flexGrow: 1 }}>
                        <Typography variant="h6" sx={{ fontWeight: 'bold', marginBottom: '16px', textAlign: 'center' }}>
                            Comentario con valoración más baja
                        </Typography>
                        <Typography variant="body1"><strong>Materia:</strong> {data.peor.materia.nombre} - {data.peor.materia.codigo} </Typography>
